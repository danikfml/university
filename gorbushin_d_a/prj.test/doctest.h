...
// ======================================================================
//
// tests.h - the lightest feature-rich C++ single-header testing framework for unit tests and TDD
//
...
#define DOCTEST_STRINGIFY(...) toString(__VA_ARGS__)
    ...
    String toString() {
                                                                                                                                ...
                                                                                                                                String ret = __FUNCSIG__; // class tests::String __cdecl tests::toString<TYPE>(void)
    String::size_type beginPos = ret.find('<');
    return ret.substr(beginPos + 1, ret.size() - beginPos - static_cast<String::size_type>(sizeof(">(void)")));
#else
        String ret = __PRETTY_FUNCTION__; // tests::String toString() [with T = TYPE]
...
#define DOCTEST_ASSERT_IN_TESTS(decomp)                                                            \
    ...
    throwException()
        ...
        // that don't depend on the template parameter in tests.cpp.
...
// in a separate namespace outside of tests because the DOCTEST_TEST_SUITE macro
...
#define DOCTEST_ASSERT_IMPLEMENT_1(assert_type, ...)                                               \
    DOCTEST_CLANG_SUPPRESS_WARNING_WITH_PUSH("-Woverloaded-shift-op-parentheses")                  \
    tests::detail::decomp_assert(                                                                \
            tests::assertType::assert_type, __FILE__, __LINE__, #__VA_ARGS__,                    \
            tests::detail::ExpressionDecomposer(tests::assertType::assert_type)                \
                    << __VA_ARGS__) DOCTEST_CLANG_SUPPRESS_WARNING_POP

#define DOCTEST_BINARY_ASSERT(assert_type, comparison, ...)                                        \
    tests::detail::binary_assert<tests::detail::binaryAssertComparison::comparison>(           \
            tests::assertType::assert_type, __FILE__, __LINE__, #__VA_ARGS__, __VA_ARGS__)

#define DOCTEST_UNARY_ASSERT(assert_type, ...)                                                     \
    tests::detail::unary_assert(tests::assertType::assert_type, __FILE__, __LINE__,            \
...
#define DOCTEST_REGISTER_EXCEPTION_TRANSLATOR(signature)                                           \
    template <typename DOCTEST_UNUSED_TEMPLATE_TYPE>                                               \
    static inline tests::String DOCTEST_ANONYMOUS(DOCTEST_ANON_TRANSLATOR_)(signature)
...
#define DOCTEST_WARN_EQ(...) [&] { return tests::detail::eq(__VA_ARGS__); }()
#define DOCTEST_CHECK_EQ(...) [&] { return tests::detail::eq(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_EQ(...) [&] { return tests::detail::eq(__VA_ARGS__); }()
#define DOCTEST_WARN_NE(...) [&] { return tests::detail::ne(__VA_ARGS__); }()
#define DOCTEST_CHECK_NE(...) [&] { return tests::detail::ne(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_NE(...) [&] { return tests::detail::ne(__VA_ARGS__); }()
#define DOCTEST_WARN_LT(...) [&] { return tests::detail::lt(__VA_ARGS__); }()
#define DOCTEST_CHECK_LT(...) [&] { return tests::detail::lt(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_LT(...) [&] { return tests::detail::lt(__VA_ARGS__); }()
#define DOCTEST_WARN_GT(...) [&] { return tests::detail::gt(__VA_ARGS__); }()
#define DOCTEST_CHECK_GT(...) [&] { return tests::detail::gt(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_GT(...) [&] { return tests::detail::gt(__VA_ARGS__); }()
#define DOCTEST_WARN_LE(...) [&] { return tests::detail::le(__VA_ARGS__); }()
#define DOCTEST_CHECK_LE(...) [&] { return tests::detail::le(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_LE(...) [&] { return tests::detail::le(__VA_ARGS__); }()
#define DOCTEST_WARN_GE(...) [&] { return tests::detail::ge(__VA_ARGS__); }()
#define DOCTEST_CHECK_GE(...) [&] { return tests::detail::ge(__VA_ARGS__); }()
#define DOCTEST_REQUIRE_GE(...) [&] { return tests::detail::ge(__VA_ARGS__); }()
...
#define DOCTEST_WARN_THROWS_WITH(expr, with, ...) [] { static_assert(false, "Exception translation is not available when tests is disabled."); return false; }()
    ...
    namespace {
        ...
        DOCTEST_NORETURN void throw_exception(Ex const& e) {
            ...
            throw e;
                                                                                                                                    ...
                                                                                                                                    std::cerr << "tests will terminate because it needed to throw an exception.\n"
...
#define DOCTEST_INTERNAL_ERROR(msg)                                                                \
    throw_exception(std::logic_error(                                                              \
            __FILE__ ":" DOCTEST_TOSTR(__LINE__) ": Internal tests error: " msg))
...
// clang-format on
    ...
    struct FatalConditionHandler
    {
        ...
        FatalConditionHandler() {
            isSet = true;
            // 32k seems enough for tests to handle stack overflow,
...
// =================================================================================================
        ...
        struct XmlReporter : public IReporter {
            ...
            void test_run_start() override {
                ...
                xml.startElement("tests").writeAttribute("binary", binary_name);
        ...
        struct ConsoleReporter : public IReporter {
            ...
            void printVersion() {
                if (opt.no_version == false)
                    s << Color::Cyan << "[tests] " << Color::None << "tests version is \""
                      << DOCTEST_VERSION_STR << "\"\n";
            }
            ...
            void printHelp() {
                ...
                s
                        ...
                        << Whitespace(sizePrefixDisplay * 1) << "skips all runtime tests operations\n";
                s
            ...
            void printRegisteredReporters() {
                ...
                auto printReporters = [this](const reporterMap& reporters, const char *type) {
                    if (reporters.size()) {
                        s << Color::Cyan << "[tests] " << Color::None << "listing all registered " << type << "\n";
            ...
            void report_query(const QueryData& in) override {
                if (opt.version) {
                    ...
                    s << Color::Cyan << "[tests] " << Color::None << "listing all test suites\n";
                    separator_to_stream();
            ...
            void test_run_end(const TestRunStats& p) override {
                ...
                s << Color::Cyan << "[tests] " << Color::None << "test cases: " << std::setw(totwidth)
                ...
                s << "\n";
                s << Color::Cyan << "[tests] " << Color::None << "assertions: " << std::setw(totwidth)
                  << p.numAsserts << " | "
